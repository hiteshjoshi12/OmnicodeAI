...
// // We map the amount (in INR) to the number of credits to prevent frontend hacking
// const CREDIT_PACKAGES = {
//   99: 50,   // ₹99 gives 50 credits
//   199: 120, // ₹199 gives 120 credits
//   499: 350  // ₹499 gives 350 credits
// };
...
//     // 2. Safely get the user ID (handling different ways auth middlewares attach it)
//     const userId = req.user.id || req.user._id;

//     const options = {
//       amount: amount * 100, // Razorpay expects amount in PAISE
//       currency: "INR",
//       // FIX: Keep receipt under 40 characters by slicing the ID and Date!
...
//     // 2. Compare signatures to prevent fraud
//     if (razorpay_signature === expectedSign) {
      
//       const userId = req.user.id || req.user._id;
//       const user = await User.findById(userId);
      
//       // 3. Upgrade Logic Based on Amount (₹499)
//       if (amountPaid === 499) {
//         user.plan = 'Pro';
//         user.credits += 1000; 
//       } else {
...
//       // 2. Upgrade Logic Based on Amount
//       if (amountPaid === 499) {
//         newPlan = 'Pro';
//         creditsToAdd = 1000;
//         user.plan = newPlan;
...
//         // Beautiful Dark-Themed HTML Receipt
//         const mailOptions = {
...
//                 <a href="http://localhost:5173/dashboard" style="display: inline-block; padding: 12px 24px; background-color: #4f46e5; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">Go to Dashboard</a>
...
//         // We use await, but inside a try/catch so if the email fails, 
//         // the user still gets their upgraded plan and no error is thrown to the frontend.
